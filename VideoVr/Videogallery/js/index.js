...
import { BoxLineGeometry } from "https://unpkg.com/three@0.141.0//examples/jsm/geometries/BoxLineGeometry.js";

import ThreeMeshUI from "../src/three-mesh-ui.js";

import hellbound from "./assets/hellbound.jpg";
...
function makeTextPanel() {
  ...
  new THREE.TextureLoader().load(hellbound, (texture) => {
    leftSubBlock.set({
