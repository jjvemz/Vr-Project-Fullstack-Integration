...
var _Quaternion = require("three/src/math/Quaternion.js");
...
function () {
  ...
  _createClass(PropertyMixer, [{
    ...
    value: function _slerpAdditive(buffer, dstOffset, srcOffset, t, stride) {
      ...
      _Quaternion.Quaternion.multiplyQuaternionsFlat(buffer, workOffset, buffer, dstOffset, buffer, srcOffset); // Slerp to the intermediate result
